...
public abstract class List<A> {
  ...
  public static List<Integer> addPairwise(List<Integer> list1, List<Integer> list2) {
    return addPairwise_(list(), list1, list2).eval().reverse();
  }

  private static TailCall<List<Integer>> addPairwise_(List<Integer> acc, List<Integer> list1, List<Integer> list2) {
    return list1.isEmpty() || list2.isEmpty()
        ? ret(acc)
        : sus(() -> addPairwise_(new Cons<>(list1.head() + list2.head(), acc),
