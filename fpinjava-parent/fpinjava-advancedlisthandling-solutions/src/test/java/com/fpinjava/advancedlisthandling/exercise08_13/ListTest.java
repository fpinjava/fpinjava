...
public class ListTest {
  ...
  public void testGetAt__() throws Exception {
    ...
    assertEquals("Failure(java.lang.IllegalStateException: Index out of bound)", list.getAt__(10).toString());
    assertEquals("Failure(java.lang.IllegalStateException: Index out of bound)", list.getAt__(11).toString());
  }
}
