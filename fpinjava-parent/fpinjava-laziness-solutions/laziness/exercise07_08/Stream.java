...
public abstract class Stream<T> {
  ...
  static Stream<Integer> ones = Stream.<Integer>cons(() -> 1, () -> Stream.ones); // Changes to take, to be reported in all classes

  public static <T> Stream<T> constant(T t) { // Changes to take, to be reported in all classes
