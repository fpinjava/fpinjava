...
public class SimpleStateTest {
  ...
  public void testNonNegativeEven() {
    Tuple<Double, RNG> t1 = SimpleState.doubleRnd.apply(new Simple(1));
    assertEquals(Double.valueOf(1.7916224896907806E-4), t1._1);
    Tuple<Double, RNG> t2 = SimpleState.doubleRnd.apply(t1._2);
    assertEquals(Double.valueOf(0.5360936457291245), t2._1);
  }

  @Test
  public void testMap2IntDouble() {
    Tuple<Tuple<Integer, Double>, RNG> t1 = SimpleState.randIntDouble.apply(new Simple(1));
    assertEquals(Integer.valueOf(384748), t1._1._1);
    assertEquals(Double.valueOf(0.5360936457291245), t1._1._2);
  }
  ...
  public void testMap2DoubleInt() {
    Tuple<Tuple<Double, Integer>, RNG> t1 = SimpleState.randDoubleInt.apply(new Simple(1));
    assertEquals(Double.valueOf(1.7916224896907806E-4), t1._1._1);
  ...
  public void testInts3() {
    assertEquals(List.list().toString(), SimpleState.ints(0).apply(new Simple(1))._1.toString());
    assertEquals(List.list(384748, -1151252339, -549383847, 1612966641).toString(), SimpleState.ints(4).apply(new Simple(1))._1.toString());
  }

  @Test
  public void testNonNegativeLessThan() {
    Tuple<Integer, RNG> t1 = SimpleState.nonNegativeLessThan(10).apply(new Simple(1));
    assertEquals(Integer.valueOf(8), t1._1);
    Tuple<Integer, RNG> t2 = SimpleState.nonNegativeLessThan(10).apply(t1._2);
    assertEquals(Integer.valueOf(8), t2._1);
    Tuple<Integer, RNG> t3 = SimpleState.nonNegativeLessThan(10).apply(t2._2);
    assertEquals(Integer.valueOf(6), t3._1);
    Tuple<Integer, RNG> t4 = SimpleState.nonNegativeLessThan(10).apply(t3._2);
    assertEquals(Integer.valueOf(1), t4._1);
    Tuple<Integer, RNG> t5 = SimpleState.nonNegativeLessThan(10).apply(t4._2);
  ...
  public void testRollDieBug() {
    assertEquals(Integer.valueOf(0),  SimpleState.rollDieBug.apply(new Simple(5))._1);
  }

  @Test
  public void testRollDie() {
    assertEquals(Integer.valueOf(1),  SimpleState.rollDie.apply(new Simple(5))._1);
  }
