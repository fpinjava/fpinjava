...
public class Trace {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(Stream.cons(() -> 11, cons(2, 3, 4).map(x -> x + 10)).filter(x -> x % 2 == 0).toList()); //#A

    System.out.println(cons(2,3,4).map(x -> x + 10).filter(x -> x % 2 == 0).toList()); //#B

    System.out.println(Stream.cons(() -> 12, cons(3, 4).map(x -> x + 10)).filter(x -> x % 2 == 0).toList()); //#C

    System.out.println(concat(list(12), cons(3,4).map(x -> x + 10).filter(x -> x % 2 == 0).toList())); //#D

    System.out.println(concat(list(12), Stream.cons(() -> 13, cons(4).map(x -> x + 10)).filter(x -> x % 2 == 0).toList()));

    System.out.println(concat(list(12), cons(4).map(x -> x + 10).filter(x -> x % 2 == 0).toList()));

    System.out.println(concat(list(12), Stream.cons(() -> 14, Stream.<Integer>empty().map(x -> x + 10)).filter(x -> x % 2 == 0).toList()));
